export default function BitcoinIcon({ className }: { className?: string }) {
  return (
    <svg
      ...
      fill="none"
      className={className}
      aria-labelledby="bitcoinIconTitle"
      role="img"
    >
      <title id="bitcoinIconTitle">Bitcoin icon</title>
      <g clipPath="url(#clip0_3111_22262)">
        <path
          d="M2 8.5H13"
          stroke="#1e1f25"
          strokeWidth="1.5"
