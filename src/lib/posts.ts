...
export const allPosts: Post[] = [
  {
    ...
    excerpt:
      "Estudo com mais de 21 mil participantes mostra as tendências, preferências e desafios do trabalho híbrido no mundo e aponta caminhos estratégicos para líderes e RHs.",
